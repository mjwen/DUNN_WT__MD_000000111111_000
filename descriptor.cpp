...
void Descriptor::set_species(std::vector<std::string> & species) {
  species_ = species;
}
void Descriptor::get_species(std::vector<std::string> & species){
  species = species_;
}

int Descriptor::get_num_species(){
  return species_.size();
}

void Descriptor::set_cutoff(const char * name, const int Nspecies, const double * rcut_2D)
{
...
double Descriptor::get_cutoff(int iCode, int jCode) {
...
bool Descriptor::need_normalize()
{
  return normalize_;
}

void Descriptor::get_feature_mean_and_std(int i,
                                          double & mean,
                                          double & std)
{
