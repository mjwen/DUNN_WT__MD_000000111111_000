...
public:
  ...
  void add_descriptor(char const *name, double const *values, int const row,
                      int const col);
  int read_parameter_file(FILE *const filePointer);
  int get_num_descriptors();
  void set_feature_mean_and_std(bool normalize, int const size,
                                double const *means, double const *stds);
  ...
  void generate_one_atom(int const i, VectorOfSizeDIM const *const coordinates,
                         int const *particleSpeciesCode, int const *neighlist,
                         int const numnei, double *const desc,
                         double *const grad_desc, bool grad);
...
private:
  ...
  void sym_g4(double zeta, double lambda, double eta, const double *r,
              const double *rcut, double &phi);
  void sym_g5(double zeta, double lambda, double eta, const double *r,
              const double *rcut, double &phi);
  ...
  void sym_d_g4(double zeta, double lambda, double eta, const double *r,
                const double *rcut, double &phi, double *const dphi);
  void sym_d_g5(double zeta, double lambda, double eta, const double *r,
                const double *rcut, double &phi, double *const dphi);
